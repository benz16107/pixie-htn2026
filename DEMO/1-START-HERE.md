...
3. Open case 138, guideline, backtest, and Intact in separate tabs.
...
| 2:50 | Show the agent result and challenge | "Agents decide where to look and write the explanation. Code owns the score and verifies the numbers in their prose." |
| 3:30 | Run the sponsor-specific beat | Follow the current track card. |
...
For Intact or Expo, start on /intact, move to the phone, complete the quote, and finish with the referral handoff. Do not mix the commercial and renter scripts until the handoff.
