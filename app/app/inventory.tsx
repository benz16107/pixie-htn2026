...
const st = StyleSheet.create({
  ...
  thumbWrap: { width: 84, height: 84, borderRadius: 4, overflow: 'hidden' },
  ...
  skeleton: { backgroundColor: C.land, borderRadius: 4 },
  line: { paddingVertical: 10, borderTopWidth: 1, borderTopColor: C.rule, borderStyle: 'dashed' },
  lineOff: { opacity: 0.45 },
  checkbox: { width: 20, height: 20, borderRadius: 4, borderWidth: 1.5, borderColor: C.dim },
  ...
  adjustBtn: { width: 34, height: 34, borderRadius: 4, borderWidth: 1, borderColor: C.ink, alignItems: 'center', justifyContent: 'center' },
