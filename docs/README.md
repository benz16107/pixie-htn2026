...
Start with [the judging guide](../DEMO/README.md).

| Document | Use it for |
| --- | --- |
| [RUNBOOK.md](RUNBOOK.md) | Starting, checking, and recovering the demo |
| [ARCHITECTURE.md](ARCHITECTURE.md) | How the two products share the engine |
...
Research notes under `docs/research/` support the market and underwriting claims. They are background material rather than booth scripts.
