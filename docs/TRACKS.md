...
| Intact | Connected Home and Auto experience over deterministic tenant, Auto, driving, MCP, and recovery services | Show the web system map, the consumer Expo app, and one live sourced MCP request | Home pricing is tenant-only; Auto and route inputs are illustrative; no displayed price is an Intact offer |
